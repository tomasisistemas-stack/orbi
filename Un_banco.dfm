object fr_banco: Tfr_banco
  ...
  object GroupBox1: TsGroupBox
    ...
    object Prnom_banco: TsEdit
      ...
      ParentFont = False
      TabOrder = 1
      OnKeyPress = Prnom_bancoKeyPress
      SkinData.SkinSection = 'EDIT'
      BoundLabel.Indent = 0
      BoundLabel.Font.Charset = DEFAULT_CHARSET
      BoundLabel.Font.Color = clWindowText
    ...
    object cbArqRemessa: TComboBox
      ...
      TabOrder = 3
      Text = 'c240'
      OnChange = cbArqRemessaChange
      Items.Strings = (
        'c240'
        'c400')
    end
    object PrLAYOUT_REMESSA: TsEdit
      Left = 201
      Top = 100
      Width = 73
      Height = 21
