object fm_minasoft_pedidos: Tfm_minasoft_pedidos
  Left = 143
  Top = 137
  Caption = 'Importa'#231#227'o de Pedidos do Sistema Minasoft.'
  ClientHeight = 564
  ClientWidth = 761
  Color = clBtnFace
  ...
  object mmMinaPedidos: TRxMemoryData
    ...
    Left = 384
    Top = 152
    object mmMinaPedidosCLIENTE: TIntegerField
      FieldName = 'CLIENTE'
    end
    object mmMinaPedidosCLIENTE_NOME: TStringField
      FieldName = 'CLIENTE_NOME'
      Size = 100
    end
    object mmMinaPedidosDOCUMENTO: TIntegerField
      FieldName = 'DOCUMENTO'
    end
    object mmMinaPedidosVENDEDOR: TIntegerField
      FieldName = 'VENDEDOR'
    end
    object mmMinaPedidosVENDEDOR_NOME: TStringField
      FieldName = 'VENDEDOR_NOME'
      Size = 100
    end
    object mmMinaPedidosEMISSAO: TDateField
      FieldName = 'EMISSAO'
    end
    object mmMinaPedidosCONDICAO: TIntegerField
      FieldName = 'CONDICAO'
    end
    object mmMinaPedidosFORMA_PGTO: TStringField
      FieldName = 'FORMA_PGTO'
      Size = 100
    end
    object mmMinaPedidosVALOR: TCurrencyField
      FieldName = 'VALOR'
    end
    object mmMinaPedidosSITUACAO: TIntegerField
      FieldName = 'SITUACAO'
    end
    object mmMinaPedidosOBS: TStringField
      FieldName = 'OBS'
      Size = 100
    end
    object mmMinaPedidoscheck: TBooleanField
      FieldName = 'check'
    end
  end
  object fR_RELATORIO: TfrxReport
    ...
    ReportOptions.LastChange = 41600.351550902800000000
