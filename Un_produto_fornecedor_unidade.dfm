object Fr_produto_fornecedor_unidade: TFr_produto_fornecedor_unidade
  Left = 456
  Top = 186
  BorderIcons = [biSystemMenu]
  Caption = 'Fornecedor - Unidades'
  ClientHeight = 83
  ClientWidth = 491
  Color = clBtnFace
  ...
  object GroupBox1: TsGroupBox
    ...
    object PrQUANT_UNID: TsCurrencyEdit
      Left = 196
      Top = 22
      Width = 80
      Height = 21
    ...
    object PrPRODUTO_FORNECEDOR_ID: TsEdit
      Left = 3
      Top = 22
      Width = 89
      Height = 21
  ...
  object q_produto_fornecedor_unidade: TFDQuery
    Connection = dao.CN
    Left = 464
    Top = 8
  end
