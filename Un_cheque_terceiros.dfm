object Fr_cheque_terceiros: TFr_cheque_terceiros
  Left = 164
  Top = 163
  BorderIcons = [biSystemMenu]
  Caption = 'Cadastro de Cheques de Terceiros'
  ClientHeight = 381
  ClientWidth = 572
  Color = clBtnFace
  ...
  object Prnr_cheque: TsEdit
    ...
    ParentFont = False
    TabOrder = 0
    OnKeyPress = Prnr_chequeKeyPress
  ...
  object Prcheque_depositado: TsCheckBox
    Left = 422
    Top = 191
    Width = 122
    Height = 20
    TabStop = False
    Caption = 'Depositado em Conta'
    TabOrder = 11
    OnKeyPress = Prnr_chequeKeyPress
  ...
  object Q_cheque_terceiros: TFDQuery
    Connection = dao.CN
    Left = 504
    Top = 56
  end
